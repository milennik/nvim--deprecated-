...
vim.keymap.set('n', '<F1>', ':lua require("harpoon.ui").nav_file(1)<cr>', { desc = 'Jump to file 1' })
vim.keymap.set('n', '<F2>', ':lua require("harpoon.ui").nav_file(2)<cr>', { desc = 'Jump to file 2' })
vim.keymap.set('n', '<F3>', ':lua require("harpoon.ui").nav_file(3)<cr>', { desc = 'Jump to file 3' })
